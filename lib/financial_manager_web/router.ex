defmodule FinancialManagerWeb.Router do
  ...
  import FinancialManagerWeb.UserAuth
  ...
  # scope "/api", FinancialManagerWeb do
  #   pipe_through :api
  # end
  ...
  scope "/", FinancialManagerWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{FinancialManagerWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", FinancialManagerWeb do
    ...
    live_session :current_user,
      on_mount: [{FinancialManagerWeb.UserAuth, :mount_current_user}] do
